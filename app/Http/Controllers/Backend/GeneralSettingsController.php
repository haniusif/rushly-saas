    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/GeneralSettings/Index', [
            ...
            't' => [
                ...
                'login_bg'      => __('settings.login_bg') ?: 'Login background image',
                'login_bg_help' => __('settings.login_bg_help') ?: 'Wide image shown behind the login card. Recommended 1920×1080.',
