...
return [
    ...
    'sub_pages' => [
        ...
        'logs' => [
            ...
            'cross_links' => 'Every model with the Spatie ActivityLog trait emits entries here — User, Shipment, Merchant, Hub, Support, Account, Payment, Role, GeneralSettings, NotificationSettings, NewsOffer, Salary, Upload, AssetCategory, Packaging, ToDo and more. Entries are grouped by the log_name bucket.',
