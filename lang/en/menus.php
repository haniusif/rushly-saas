...
return [
  ...
  'social_login_settings' => 'Social login settings',
    //new
   'pay_out'                  => 'Payment gateway Setup',
   'payment_gateway'          => 'Payment Gateway',
   'payment_details'           => 'Payment Details',
   'payout_setup'              => 'Payment gateway Setup',
   'payout_setup_updated'       => 'Payment gateway Setup updated successfully',
   'payout'                     => 'Payout',

   'payments_received'           => 'Payment Received',
   'online_payment_setup'        => 'Payment gateway Setup',
