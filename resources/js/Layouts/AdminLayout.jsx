...
const NAV = [
    ...
    { group: 'menu_parcels', items: [
        ...
        { tKey: 'menu_bulk_action', icon: Wand2,          route: 'parcel.bulk_action', match: ['admin/parcel/bulk'], perm: 'parcel_read' },
        { tKey: 'menu_ndr',         icon: AlertTriangle,  route: 'ndr.index',          match: ['admin/ndr'], perm: 'ndr_manage' },
        { tKey: 'menu_abnormal',    icon: Hourglass,      route: 'abnormal.index',     match: ['admin/abnormal'], perm: 'abnormal_manage' },
    ]},
    { group: 'menu_wms', items: [
        { tKey: 'menu_wms_dashboard', icon: BarChart3,       route: 'wms.dashboard',          match: ['admin/wms/dashboard'], perm: 'wms_manage' },
        { tKey: 'menu_products',      icon: Boxes,           route: 'wms.products.index',     match: ['admin/wms/products'], perm: 'wms_manage' },
        { tKey: 'menu_stock',         icon: ClipboardList,   route: 'wms.stock.index',        match: ['admin/wms/stock'], perm: 'wms_manage' },
        { tKey: 'menu_locations',     icon: MapPin,          route: 'wms.locations.index',    match: ['admin/wms/locations'], perm: 'wms_manage' },
        { tKey: 'menu_grn',           icon: Inbox,           route: 'wms.grn.index',          match: ['admin/wms/grn'], perm: 'wms_manage' },
        { tKey: 'menu_fulfillment',   icon: Package,         route: 'wms.fulfillment.index',  match: ['admin/wms/fulfillment'], perm: 'wms_manage' },
        { tKey: 'menu_outbound',      icon: Send,            route: 'wms.outbound.index',     match: ['admin/wms/outbound'], perm: 'wms_manage' },
        { tKey: 'menu_adjustments',   icon: ArrowRightLeft,  route: 'wms.adjustments.index',  match: ['admin/wms/adjustments'], perm: 'wms_manage' },
        { tKey: 'menu_cycle_counts',  icon: CheckSquare,     route: 'wms.cycle-counts.index', match: ['admin/wms/cycle-counts'], perm: 'wms_manage' },
        { tKey: 'menu_damage',        icon: Bug,             route: 'wms.damage.index',       match: ['admin/wms/damage'], perm: 'wms_manage' },
    ...
    { group: 'menu_operations', items: [
        ...
        { tKey: 'menu_hubs',           icon: Warehouse,  route: 'hubs.index',              match: ['admin/hub'], perm: 'hub_read' },
        { tKey: 'menu_pickup_request', icon: Inbox,      route: 'pickup.request.regular',  match: ['admin/pickup-request'], perm: 'pickup_request_regular' },
    ]},
    ...
    { group: 'menu_users_management', items: [
        { tKey: 'menu_merchants',       icon: Users,      route: 'merchant.index',            match: ['admin/merchant'], perm: 'merchant_read' },
        { tKey: 'menu_deliveryman',     icon: Truck,      route: 'deliveryman.index',         match: ['admin/deliveryman'], perm: 'delivery_man_read' },
        { tKey: 'menu_users_roles',     icon: UserCog,    route: 'users.index',               match: ['admin/users','admin/roles'], perm: 'user_read' },
    ...
    { group: 'menu_hr', items: [
        { tKey: 'menu_payroll',     icon: Briefcase,  route: 'salary.index',  match: ['admin/salary'], perm: 'salary_read' },
        { tKey: 'menu_assets',      icon: HardDrive,  route: 'asset.index',   match: ['admin/assets'], perm: 'assets_read' },
    ]},
    { group: 'menu_productivity', items: [
        { tKey: 'menu_todo',              icon: ListChecks,    route: 'todo.index',              match: ['admin/todo'], perm: 'todo_read' },
        { tKey: 'menu_support',           icon: MessageCircle, route: 'support.index',           match: ['admin/support'], perm: 'support_read' },
        { tKey: 'menu_news',              icon: Newspaper,     route: 'news-offer.index',        match: ['admin/news-offer'], perm: 'news_offer_read' },
        { tKey: 'menu_push_notification', icon: BellRing,      route: 'push-notification.index', match: ['admin/push-notification'], perm: 'push_notification_read' },
    ...
    { group: 'menu_zatca', items: [
        { tKey: 'menu_zatca_invoices', icon: Receipt,   route: 'zatca.invoices.index', match: ['admin/zatca/invoices'], perm: 'zatca_manage' },
        { tKey: 'menu_zatca_settings', icon: FileText,  route: 'zatca.settings.index', match: ['admin/zatca/settings'], perm: 'zatca_manage' },
    ]},
    { group: 'menu_cms', items: [
        { tKey: 'menu_front_web', icon: Layout, route: 'blogs.index', match: ['admin/front-web'], perm: 'blogs_read' },
    ]},
    { group: 'menu_system', items: [
        { tKey: 'menu_logs', icon: History, route: 'logs.index', match: ['admin/logs'], perm: 'log_read' },
    ]},
    { group: 'menu_settings', items: [
        ...
        { tKey: 'menu_liquid_fragile',          icon: AlertTriangle, route: 'liquid-fragile.index',           match: ['admin/liquid-fragile'], perm: 'liquid_fragile_read' },
        ...
        { tKey: 'menu_assets_category',         icon: Tags,          route: 'asset-category.index',           match: ['admin/asset-category'], perm: 'asset_category_read' },
        { tKey: 'menu_invoice_generate',        icon: FileText,      route: 'invoice.generate.menually.index', match: ['admin/settings/invoice-generate'], perm: 'invoice_generate_menually' },
