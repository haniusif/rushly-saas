                ...
                <form onSubmit={onSubmit}>
                    <Card>
                        <CardContent className="space-y-4 p-6">
                            ...
                            <Field label={t.city} required error={form.errors.city_id}>
                            ...
                            <Field label={t.code} error={form.errors.area_code}>
                                <Input value={form.data.area_code} onChange={(e) => form.setData('area_code', e.target.value)} className="font-mono" />
                            </Field>
