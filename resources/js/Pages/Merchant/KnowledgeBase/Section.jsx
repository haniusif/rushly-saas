...
import {
    ...
    Package, PiggyBank, BarChart3, Settings,
...
function Screenshot({ section, sub, label, icon: Icon, version, canUpdate = false }) {
    ...
    const handleFile = (e) => {
        ...
        router.post(
            route('merchant-panel.kb.screenshot.upload', { section, sub }),
            { screenshot: file },
            {
    ...
    const handleDelete = () => {
        ...
        setError(null); setUploading(true);
        router.delete(route('merchant-panel.kb.screenshot.delete', { section, sub }), {
            preserveScroll: true,
    ...
    return (
        <Card className="sticky top-4">
            <CardContent className="p-3">
                <Link href={route('merchant-panel.kb.index')}
                ...
                <div className="mt-2 px-2 py-1 text-xs font-semibold uppercase tracking-wide text-muted-foreground">{section.label}</div>
