                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group" id="weight_group">
                                 ...
                                 <div class="form-group" id="extra_weight_price">
                                    ...
                                    <input id="extra_weight_price" type="number" name="extra_weight_price" step="0.1" min="0"  placeholder="{{ __('levels.extra_weight_price') }}"   class="form-control" value="{{ old('weight',$delivery_charge->extra_weight_price) }}" >
