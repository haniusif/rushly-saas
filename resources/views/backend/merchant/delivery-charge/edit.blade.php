                ...
                <div id="deliveryChargeInfo">
                    <div class="row">
                           ...
                           <div class="form-group" id="extra_weight_price">
                                    ...
                                    <input id="extra_weight_price" type="number" name="extra_weight_price" step="0.1" min="0"  placeholder="{{ __('Extra weight price') }}"   class="form-control" value="{{old('extra_weight_price',$merchantDeliveryCharge->extra_weight_price)}}" >
                        ...
                        <div class="form-group col-6">
                            ...
                            <input id="same_day" type="number" name="same_day" step="0.01" min="0" data-parsley-trigger="change" placeholder="{{ __('placeholder.enter_same_day') }}" autocomplete="off" class="form-control" value="{{old('same_day',$merchantDeliveryCharge->same_day)}}" require>
                            @error('same_day')
                            <small class="text-danger mt-2">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-6">
                            ...
                            <input id="next_day" type="number" name="next_day" step="0.01" min="0" data-parsley-trigger="change" placeholder="{{ __('placeholder.enter_next_day') }}" autocomplete="off" class="form-control" value="{{old('next_day',$merchantDeliveryCharge->next_day)}}" require>
                            @error('next_day')
                            <small class="text-danger mt-2">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-6">
                            ...
                            <input id="sub_city" type="number" name="sub_city" step="0.01" min="0" data-parsley-trigger="change" placeholder="{{ __('placeholder.enter_sub_city') }}" autocomplete="off" class="form-control" value="{{old('sub_city',$merchantDeliveryCharge->sub_city)}}" require>
                            @error('sub_city')
                            <small class="text-danger mt-2">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-6">
                            ...
                            <input id="outside_city" type="number" name="outside_city" step="0.01" min="0" data-parsley-trigger="change" placeholder="{{ __('placeholder.enter_outside_city') }}" autocomplete="off" class="form-control" value="{{old('outside_city',$merchantDeliveryCharge->outside_city)}}" require>
                            @error('outside_city')
                            <small class="text-danger mt-2">{{ $message }}</small>
                            @enderror
                        </div>
