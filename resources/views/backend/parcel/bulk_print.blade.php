        ...
        <div class="card-body" >
            <div class="invoice" id="printablediv">
                <div class="row mt-3" style="width:100%">
                    <div class="col-sm-12  ">
                        <h1 style="text-align: center"> {{ ($report_name) ? $report_name :  __('parcelStatus.'.$bulk_type) }}</h1>
                    </div>
                </div>
                <div class="row mt-3" style="width:100%">
                    <div class="col-sm-12 " style="overflow: hidden">
                        <span  style="float: left">
                            <font style="font-weight: bold">{{ __('Courier') }} :</font>  <small>{{ @$deliveryman->user->name }}</small>
                        </span>
            ...
            ?>
                                        ...
                                        <td data-label="customer_details">
                                            ...
                                            {{ $parcel->city->en_name ?? ''  }} , {{ $parcel->area->en_name ?? ''  }}<br/>
                                        ...
                                        @endif
                                        <td data-label="status ">{{ $parcel->package_description }}</td>
                                        <td data-label="cash_collection "><b>{{ $parcel->cash_collection }}</b>  {{ settings()->currency }}</td>
                                    </tr>
