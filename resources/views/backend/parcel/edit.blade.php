...
@section('maincontent')
    ...
    {{-- User has finance_update permission → show editable input --}}
    <div class="form-group col-12 col-md-6">
        <label for="cash_collection">{{ __('parcel.cash_collection') }} </label>
        <span class="text-danger">*</span>

        <div class="form-control-wrap">
            <input type="text"
                   class="form-control cash-collection"
                   id="cash_collection"
...
@else
    ...
    {{-- User does NOT have finance_update permission → show value only (readonly) --}}
    <div class="form-group col-12 col-md-6">
        <label>{{ __('parcel.cash_collection') }}</label>

        <div class="form-control-wrap">
            <input type="text"
                   class="form-control"
                   value="{{ $parcel->cash_collection }}"
                   readonly
                   disabled
    ...
    <div class="form-group col-12 col-md-6">
        ...
        <select id="city_id" name="city_id" class="form-control select2">
            ...
            @foreach($cities as $city)
                <option @selected($city->id == $parcel->city_id) value="{{ $city->id }}">
                {{ $city->en_name }}
                </option>
            @endforeach
        </select>
        ...
        <select id="area_id" name="area_id" class="form-control select2">
            <option value="">{{ __('Select Area') }}</option>
               ...
               @foreach($areas as $area)
                <option @selected($area->id == $parcel->area_id) value="{{ $area->id }}">
                {{ $area->en_name }}
                </option>
            @endforeach
