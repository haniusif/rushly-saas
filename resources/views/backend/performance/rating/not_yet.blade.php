...
<head>
    ...
    <title>Parcel not delivered yet</title>
    ...
    <style>
        ...
        .clock { width: 64px; height: 64px; border-radius: 50%; background: #fef3c7; color: #92400e; display: inline-flex; align-items: center; justify-content: center; font-size: 32px; margin-bottom: 12px; }
...
<body>
    <div class="wrap">
        <div class="card">
            <div class="clock">⏳</div>
            <h1>Hold tight!</h1>
            <p>This parcel hasn't been delivered yet. Please come back after delivery to rate.</p>
