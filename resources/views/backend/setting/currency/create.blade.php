            ...
            <div class="tw-max-w-2xl">
                <div class="tw-bg-white tw-border tw-border-gray-100 tw-rounded-xl tw-shadow-card tw-overflow-hidden">
                    <div class="tw-px-6 tw-py-5 tw-border-b tw-border-gray-100">
                        <h1 class="tw-text-lg tw-font-semibold tw-text-gray-900 tw-m-0">{{ __('settings.currency') }} {{ __('levels.add') }}</h1>
                    </div>
                    <form action="{{ route('currency.store') }}" method="POST" enctype="multipart/form-data" id="basicform">
                        ...
                        <div class="tw-p-6 tw-space-y-5">
                            ...
                            <div>
                                <label for="exchange_rate" class="tw-block tw-text-sm tw-font-medium tw-text-gray-700 tw-mb-1.5">
                                    {{ __('settings.exchange_rate') }} <span class="tw-text-xs tw-font-normal tw-text-gray-400">(1 Dollar = )</span> <span class="tw-text-red-500">*</span>
                                </label>
                                <input id="exchange_rate" type="number" step="any" name="exchange_rate" placeholder="{{ __('settings.enter_exchange_rate') }}" autocomplete="off"
