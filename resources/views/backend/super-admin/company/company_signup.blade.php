        ...
        <div class="auth-form-section">
            <div class="auth-form-wrapper">
                ...
                <div class="auth-logo text-center mb-8">
                    ...
                    <h1 class="auth-title mt-6" data-en="Company Registration" data-ar="تسجيل الشركة">Company Registration</h1>
                    <p class="auth-subtitle" data-en="Create your company account and start managing logistics" data-ar="أنشئ حساب شركتك وابدأ في إدارة اللوجستيات">Create your company account and start managing logistics</p>
                </div>

                <!-- Company Registration Form -->
                <form method="POST" action="{{ route('company.sign-up.store') }}" class="auth-form">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input id="company_name" type="text"
                                ...
                                name="company_name" value="{{ old('company_name') }}" required autocomplete="off"
                                placeholder="Enter company name"
                                data-en-placeholder="Enter company name"
                                data-ar-placeholder="أدخل اسم الشركة">
                        </div>
                        @error('company_name')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper domain-wrapper">
                            ...
                            <input id="domain" type="text"
                                class="form-control domain-input @error('domain') is-invalid @enderror"
                                name="domain" value="{{ old('domain') }}" required autocomplete="off"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input id="email" type="email"
                                ...
                                data-en-placeholder="Enter email address"
                                data-ar-placeholder="أدخل البريد الإلكتروني">
                        </div>
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input id="mobile" type="tel"
                                ...
                                name="mobile" value="{{ old('mobile') }}" required autocomplete="off"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper textarea-wrapper">
                            ...
                            <textarea id="address" name="address" rows="4"
                                ...
                                data-en-placeholder="Enter company address"
                                data-ar-placeholder="أدخل عنوان الشركة">{{ old('address') }}</textarea>
                        </div>
                        @error('address')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
        ...
        <div class="auth-image-section">
            <div class="auth-image-overlay">
                <div class="auth-branding">
                    <h2 data-en="Grow Your Company with Rushly" data-ar="طوّر شركتك مع راشلي">Grow Your Company with Rushly</h2>
                    <p data-en="Join leading companies who trust Rushly for their logistics operations" data-ar="انضم للشركات الرائدة التي تثق براشلي لعملياتها اللوجستية">Join leading companies who trust Rushly for their logistics operations</p>
                    ...
                    <div class="feature-list">
                        ...
                        <div class="feature-item">
                            ...
                            <span data-en="Multi-User Access" data-ar="وصول متعدد المستخدمين">Multi-User Access</span>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span data-en="Scalable Solution" data-ar="حل قابل للتوسع">Scalable Solution</span>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span data-en="Dedicated Support" data-ar="دعم مخصص">Dedicated Support</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="auth-illustration">
                    <div class="illustration-box">
                        <svg width="100%" height="200" viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <!-- Office Building -->
                            <rect x="140" y="50" width="120" height="120" rx="8" fill="rgba(255,255,255,0.15)" stroke="rgba(255,255,255,0.3)" stroke-width="2"/>
                            <!-- Windows -->
                            <rect x="155" y="65" width="25" height="25" rx="4" fill="rgba(255,255,255,0.2)"/>
                            <rect x="195" y="65" width="25" height="25" rx="4" fill="rgba(255,255,255,0.2)"/>
                            <rect x="155" y="105" width="25" height="25" rx="4" fill="rgba(255,255,255,0.2)"/>
                            <rect x="195" y="105" width="25" height="25" rx="4" fill="rgba(255,255,255,0.2)"/>
                            <!-- Door -->
                            <rect x="185" y="135" width="30" height="35" rx="4" fill="rgba(255,255,255,0.25)"/>
                            <!-- Flag -->
                            <line x1="260" y1="50" x2="260" y2="90" stroke="rgba(255,255,255,0.4)" stroke-width="2"/>
                            <path d="M260 50L290 60L260 70" fill="rgba(255,255,255,0.3)" stroke="rgba(255,255,255,0.4)" stroke-width="2"/>
                            <!-- Growth Chart -->
                            <path d="M80 150L80 100L110 120L140 80" stroke="rgba(255,255,255,0.4)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
                            <circle cx="80" cy="100" r="4" fill="rgba(255,255,255,0.4)"/>
                            <circle cx="110" cy="120" r="4" fill="rgba(255,255,255,0.4)"/>
                            <circle cx="140" cy="80" r="4" fill="rgba(255,255,255,0.4)"/>
                            <!-- Check Badge -->
                            <circle cx="320" cy="140" r="25" fill="rgba(255,255,255,0.2)" stroke="rgba(255,255,255,0.4)" stroke-width="2"/>
                            <path d="M310 140L317 147L330 134" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                </div>
            </div>
...
<style>
    ...
    body.rtl .domain-prefix {
        order: 2;
        border-left: 1px solid var(--border-color);
    }

    body.rtl .domain-suffix {
        order: 0;
...
@push('scripts')
<script>
    // Language switching for company register page
    ...
    document.querySelectorAll('.form-control, .textarea-control, .domain-input').forEach(input => {
    ...
    // Domain validation - only allow alphanumeric and hyphens
