...
@section('maincontent')
    <div class="container-fluid dashboard-content">
        <div class="tw-px-1 tw-pt-4 sm:tw-px-2">
            ...
            <form action="{{ route('plan.store') }}" method="POST" enctype="multipart/form-data" id="basicform" class="tw-space-y-4">
                @csrf
                ...
                <div class="tw-bg-white tw-border tw-border-gray-100 tw-rounded-xl tw-shadow-card tw-overflow-hidden">
                    <div class="tw-px-6 tw-py-5 tw-border-b tw-border-gray-100 tw-flex tw-items-center tw-gap-3">
                        ...
                        <div>
                            <h2 class="tw-text-base tw-font-semibold tw-text-gray-900 tw-m-0">{{ __('levels.create') }} {{ __('levels.plans') }}</h2>
                            <p class="tw-text-xs tw-text-gray-500 tw-mt-0.5 tw-m-0">Subscription tier configuration.</p>
                        </div>
                    </div>
                    <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-5 tw-p-6">
                        ...
                        <div class="md:tw-col-span-2">
                            ...
                            <textarea class="tw-textarea tw-w-full tw-px-3 tw-py-2 tw-text-sm tw-bg-white tw-border tw-border-gray-200 tw-rounded-lg"
                                      placeholder="{{ __('placeholder.Enter_description') }}" name="description" rows="3"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="tw-bg-white tw-border tw-border-gray-100 tw-rounded-xl tw-shadow-card tw-overflow-hidden">
                    <div class="tw-px-6 tw-py-5 tw-border-b tw-border-gray-100 tw-flex tw-items-center tw-gap-3">
                        ...
                        <div>
                            ...
                            <p class="tw-text-xs tw-text-gray-500 tw-mt-0.5 tw-m-0">Which modules this plan includes.</p>
                        </div>
                    </div>
                    <div class="tw-p-6">
