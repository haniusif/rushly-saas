...
@section('title', __('Inbound (Receiving)'))
...
<div class="container-fluid dashboard-content">
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Inbound (Receiving)') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <p>{{ __('List of received items and purchase orders.') }}</p>
        </div>
    </div>
