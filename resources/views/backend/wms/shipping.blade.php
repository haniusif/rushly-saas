...
@section('title', __('Outbound (Shipping)'))
...
<div class="container-fluid dashboard-content">
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Outbound (Shipping)') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <p>{{ __('Orders ready for dispatch and shipment tracking.') }}</p>
        </div>
    </div>
