    ...
    if (!$domain):
        ...
        Route::group(['middleware' => 'auth'], function () {
            ...
            Route::group(['prefix' => 'admin'], function () {
                ...
                // Read-only user detail + admin password reset + notify by email.
                // Mirrored from the tenant-gated web.php block so central
                // super-admin can hit these pages too.
                ...
                // Nominate the courier record that represents a 3PL carrier.
                // Only the legacy env-configured carriers use this; Shipping-
                // module providers carry their own on the connection row.
